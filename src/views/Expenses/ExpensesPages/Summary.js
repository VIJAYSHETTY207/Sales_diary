...
return (
          <div>
            <div> 			
              <GridContainer justify="center">
                  <GridItem xs={12} sm={12} md={8} className={classes.inputMargin}> 
                    <button className={classes.CardButton} onClick={()=>this.setState({Summary:true})}>
                      <GridContainer>
                        <GridItem xs={3} sm={3} md={1} lg={1}>
                          <Typography className={classes.heading} style={{paddingTop:"7px",textAlign:"center"}}  textAlign="center">1.</Typography>
                          <p className={classes.Subheading}   style={{textAlign:"center"}}>S.No</p>
                        </GridItem> 
                        <GridItem xs={9} sm={9} md={4} lg={4}>
                          <Typography className={classes.heading} style={{paddingTop:"7px"}}>Rohan</Typography>
                          <p className={classes.Subheading}>Name</p>
                        </GridItem> 
                        <GridItem xs={8} sm={8} md={2} lg={2} textAlign="center">
                          <Typography className={classes.heading} style={{paddingTop:"7px",textAlign:"center"}}  textAlign="center">30,000</Typography>
                          <p className={classes.Subheading}   style={{textAlign:"center"}}>Approved</p>
                        </GridItem>
                        <GridItem xs={8} sm={8} md={2} lg={2} textAlign="center">
                          <Typography className={classes.heading} style={{paddingTop:"7px",textAlign:"center"}}  textAlign="center" >20,000</Typography>
                          <p className={classes.Subheading} style={{textAlign:"center"}}>Paid</p>
                        </GridItem> 
                        <GridItem xs={8} sm={8} md={2} lg={2} textAlign="center">
                          <Typography className={classes.heading} style={{paddingTop:"7px",textAlign:"center"}}  textAlign="center" >10,000</Typography>
                          <p className={classes.Subheading} style={{textAlign:"center"}} >Pending</p>
                        </GridItem>
                        <GridItem className="" xs={4} sm={4} md={1} lg={1} style={{textAlign:'right',margin:'auto'}}>    
                          <Avatar style={{float:'right',marginRight:10,color: "#3f51b5",backgroundColor: "#fff",border: "1px solid #3f51b5"}}>
                            <NavigateNext />
                          </Avatar>
                        </GridItem>
                      </GridContainer>
            ...
            <SlidingPane
              ...
              <div> 
              <GridContainer justify="center">
                <GridItem xs={12} sm={12} md={10} className={classes.inputMargin}> 
                    <Card> 
                          ...
                          <CardBody>
                              <ReactTable
                                ...
                                return ({
                                  ...
                                  submitted_on:<Tooltip title={Moment(original.created_date).format("DD-MM-YYYY h:m A")} placement="top" arrow><div>{this.datefunction(original.created_date)}</div></Tooltip>,
                                  emp_name:"Employee 1",
                                  expenses_type:"Transpotation",
                                  kms:"10",
                                  amount:"₹ 100",
                              ...
                              columns={[
                              {
                                    ...
                                    },
                                {
                                  ...
                                  className: "center",
                                    Filter: ({filter, onChange}) => (
                                      <input type='text' style={{textAlign:'center'}} placeholder="Search Expenses" value={filter ? filter.value : ''} onChange={event => onChange(event.target.value)} />
                                    )
                                },
                                {
                                  Header: "Kms",
