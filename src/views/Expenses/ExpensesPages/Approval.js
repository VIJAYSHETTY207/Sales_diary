                          ...
                          <CardBody>
                              <ReactTable
                                ...
                                return ({
                                  ...
                                  kms:"10",
                                  amount:"₹ 100",
                                  arststus: <Chip label="Approved" onClick={()=> this.setState({ApprovedOverview:true, expenseStatus:"Approved"}) } style={{backgroundColor:'green',color:'white'}} size="small"clickable variant="outlined"/>,
                              })
                              })
                              }
                              filterable
                    ...
                    <CardBody>
                      <GridContainer>
                        ...
                        <GridContainer  justify="center" alignItems="center">    
                          <GridItem xs={12} sm={12} md={12} style={{textAlign:'right',marginTop:20}}>
                            <div>
                              <MButton variant="outlined" size="sm" color="primary" >Cancel</MButton>
                            </div>
                          </GridItem> 
                       </GridContainer>
                    </CardBody>
                    ...
                    <CardBody>
                      <GridContainer>
                        ...
                        <GridContainer  justify="center" alignItems="center">    
                          <GridItem xs={12} sm={12} md={12} style={{textAlign:'right',marginTop:20}}>
                            <div>
                              <MButton variant="outlined" size="sm" color="primary">Close</MButton>
                            </div>
                          </GridItem> 
                       </GridContainer>
                    </CardBody>
