      ...
      <Toolbar className={classes.container}>
        <Hidden smDown>
          <div className={classes.flex}>
            <Button href="#" className={classes.title} color="transparent" style={{textTransform: 'none !important',fontSize:"25px",fontWeight:"400"}} >
              <img src={Logo} style={{width:'60px'}}/>&nbsp;&nbsp;{brandText}
            </Button>
          </div>
        </Hidden>
        <Hidden mdUp>
