  ...
  createLinks = routes => {
    ...
    return routes.map((prop, key) => {
      ...
      const innerNavLinkClasses =
        ...
        " " +
        cx({
          [" " + classes[color]]: this.activeRoute(prop.active)
        });
      const collapseItemMini =
        classes.collapseItemMini +
        " " +
  ...
  render() {
      ...
      <div className={userWrapperClass}>
        ...
        <List className={classes.list}>
          <ListItem className={classes.item + " " + classes.userItem}>
            ...
            >
              <ListItemText
                primary={rtlActive ? "تانيا أندرو" : this.props.data.name}
                secondary={
                  <b
                    className={
                      caret +
    ...
    var brand = (
      <div className={logoClasses}>
        <a
          href="http://salesdiary.egenius.in/"
          target="_blank"
          className={logoMini}
        >
...
export default connect(mapStateToProps, mapDispatchToPros)(withStyles(sidebarStyle)(Sidebar));
