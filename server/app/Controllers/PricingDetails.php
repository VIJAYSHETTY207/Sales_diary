...
class PricingDetails extends ResourceController
{
    ...
    { 
        try
        {
            ...
            $pricing_module_data    = $pricing_module_model->where('status',1)->findAll();
    ...
    { 
        try
        {
            ...
            $pricing_module_data    = $pricing_module_model->where('pricing_id', $pricing_id)->groupBy('main_module')->orderBy('id')->findAll();
